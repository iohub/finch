...
PRIMITIVE(NumberNeg) { return fiber.CreateNumber(-self.AsNumber()); }

PRIMITIVE(NumberSqrt) { return fiber.CreateNumber(sqrt(self.AsNumber())); }

PRIMITIVE(NumberSin) { return fiber.CreateNumber(sin(self.AsNumber())); }
PRIMITIVE(NumberCos) { return fiber.CreateNumber(cos(self.AsNumber())); }
PRIMITIVE(NumberTan) { return fiber.CreateNumber(tan(self.AsNumber())); }
PRIMITIVE(NumberAsin) { return fiber.CreateNumber(asin(self.AsNumber())); }
PRIMITIVE(NumberAcos) { return fiber.CreateNumber(acos(self.AsNumber())); }
PRIMITIVE(NumberAtan) { return fiber.CreateNumber(atan(self.AsNumber())); }
...
PRIMITIVE(NumberFloor) { return fiber.CreateNumber(floor(self.AsNumber())); }

PRIMITIVE(NumberCeiling) { return fiber.CreateNumber(ceil(self.AsNumber())); }
